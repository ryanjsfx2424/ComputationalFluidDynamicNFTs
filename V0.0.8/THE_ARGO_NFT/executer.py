...
# end for ii
#os.system("python3 prereveal_movie.py")
#os.system("rm -r Plots*")
#os.system("rm -r StateFiles*")
'''
...
## do the following after uploading movies and hidden movie
## to IPFS and modify the IPFS_URL in prereveal_json.py
## and generate_json.py

## Note, I change the name of the movies in generate_json.py
## which is why it has to be run above and then below after
## updating IPFS_URL...
#### Really I should modify the movie names above and just
#### generate the json below...

#'''
os.system("cp -r movies ..")
os.system("python3 " + fn_json)
os.system("python3 prereveal_json.py")
#'''
## end executer.py
