...
class AbeBot(object):
    def __init__(self):
        ...
        self.rating_map = {"A": "alpha-plus", "B": "alpha", "P": "aptos", "S": "solana", "D": "daos", "T": "nft-tools", "DailyEth": "daily", "Highlight":"highlight", "Artist":"artist", "C": "might-be-something", "VC": "vc-firms"}
    ...
    def discord_bot(self):
        ...
        async def on_ready():
            ...
            while True:
                ...
                #'''
                with open("data_big/22-11-07_17-20-07.txt", "r") as fid:
                    result = json.load(fid)
                # end with open
                #'''
