...
class EzuTweeteroo(object):
    def __init__(self):
        ...
        self.UNKNOWN_USERNAME = "```>>> sorry, I couldn't parse that (missing username?) I'm looking for something like\n" \
                              + 2*self.TAB + "!" + self.CMD_PREFIX + "stats bayc2745```"
        self.TAB = 4*" "
    ...
    def init_keywords(self):
        ...
        self.fname_tweets_from_project = "data_big/from_"      + self.PROJECT_TWITTER + ".txt"
    ...
    def init_data(self):
        ...
        self.get_sndata(query,   self.fname_tweets_from_project)
        self.load_project_tweets(self.fname_tweets_from_project)
