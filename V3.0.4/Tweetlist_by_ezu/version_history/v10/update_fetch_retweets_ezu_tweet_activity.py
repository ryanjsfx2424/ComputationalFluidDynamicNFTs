## update_fetch_retweets_ezu_tweet_activity.py
import os
import ast
import time
...
def update_fetch_retweets_activity(tweet_id):
    """tweet_id should be a string"""
    print("[tweet_id]: ", [tweet_id])
    print("begin update_fetch_retweets_activity")

    fname = "data_big/retweets/activity_ezu_xyz_" + tweet_id + ".txt"
    ...
    print("SUCCESS update_fetch_retweets_activity")
    return True
# end update_fetch_retweets_activity
...
if __name__ == "__main__":
    ...
    for tweet_id in tweet_ids:
        ...
        result = update_fetch_retweets_activity(tweet_id)
        if result:
          print("sleeping a minute between retweets fetches")
          time.sleep(LONG_SLEEP)
        # end if
    # end for
    print("SUCCESS update_fetch_retweets_ezu_tweet_activity")
# end if __name__ == "__main__"
## end update_fetch_retweets_ezu_tweet_activity.py
