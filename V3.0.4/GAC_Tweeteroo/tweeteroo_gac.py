...
class Tweeteroo2(object):
    def __init__(self):
        ...
        self.VERIFY1 = "!" + self.CMD_PREFIX + " https://twitter.com/RubiksLive/status/1545823406553194499"
        self.VERIFY2 = "!" + self.CMD_PREFIX + "https://twitter.com/GamingApeClub/status/1545822733350715395, TheLunaLabs"
    ...
    def init_stream_data(self):
        ...
        if not self.DEV_MODE:
            os.system("python3 stream_gac.py > logfile_stream.txt &")
        # end if not
    ...
    def init_data(self):
        ...
        if not self.DEV_MODE:
            os.system("python3 engagement_gac.py likes > logfile_likes.txt &")
            os.system("python3 engagement_gac.py retweets > logfile_retweets.txt &")
            os.system("python3 engagement_gac.py quotes > logfile_quotes.txt &")
