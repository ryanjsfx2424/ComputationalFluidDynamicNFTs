## init_fetch_quotes_ezu_tweet_activity.py
import os
import ast
import time
...
if __name__ == "__main__":
    ...
    for tweet_id in tweet_ids:
        ...
        # end if
    # end for
    print("SUCCESS init_fetch_quotes_ezu_tweet_activity")
# end if __name__ == "__main__"
## end init_fetch_quotes_ezu_tweet_activity.py