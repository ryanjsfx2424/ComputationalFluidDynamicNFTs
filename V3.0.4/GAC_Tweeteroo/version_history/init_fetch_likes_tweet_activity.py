## init_fetch_likes_tweet_activity.py
import os
import ast
import time
...
def init_fetch_likes_activity(tweet_id):
    ...
    fname = "data_big/likes/activity_gac_" + tweet_id + ".txt"
...
if __name__ == "__main__":
    ...
    for tweet_id in tweet_ids:
        ...
        if result:
          print("sleeping " + str(SLEEP_TIME) + "s between likes fetches")
          time.sleep(SLEEP_TIME)
        # end if
    # end for
    print("SUCCESS init_fetch_likes_tweet_activity")
# end if __name__ == "__main__"
## end init_fetch_likes_tweet_activity.py
