...
class Tweeteroo2(object):
    def __init__(self):
        ...
        self.CID_MSG1 = 1030885472777551872 # roo tech tweeteroo-madmetaverse
        self.CID_MSG2 = -1 #1009227419082825758 # battle.fish. seashills
        self.BOT_COMMANDS_CIDS = [self.CID_MSG1, self.CID_MSG2, self.CID_LOG]
        self.GUILDS = [993961827799158925]#,931482273440751638]#,889422434745344010] # Roo Tech, TTM, MAD

        self.CMD_PREFIX = "mad"
        self.BOT_NAME   = "Tweeteroo"
        self.FOOTER = "Built for MAD metaverse powered by Roo Tech."
        ...
        os.system("mkdir -p data_big/stream")
    ...
    def init_keywords(self):
        self.PROJECT_TWITTER = "MADmetaverse"
        self.PROJECT_TWITTER_SN = "MADmetaverse"
        ...
        query = "(@" + self.PROJECT_TWITTER + " OR BIOMETA OR Metacell OR Metascientists)"
    ...
    def init_auth(self):
        ...
        auth_str = ""
        with open("git_ignores_me_sam.mp4", "r") as fid:
            for line in fid:
    ...
    def init_stream_data(self):
        ...
        if not self.DEV_MODE:
            os.system("nohup python3 -u stream_mad.py > logfile_stream.txt 2>&1 &")
        # end if not
    ...
    def init_data(self):
        ...
        if not self.DEV_MODE:
            os.system("nohup python3 -u engagement_mad.py likes > logfile_likes.txt 2>&1 &")
            os.system("nohup python3 -u engagement_mad.py retweets > logfile_retweets.txt 2>&1 &")
            os.system("nohup python3 -u engagement_mad.py quotes > logfile_quotes.txt 2>&1 &")
    ...
    def discord_bot(self):
        ...
        async def on_message(message):
            ...
            if not prefix_in_msg:
                #print("bad msg: ", msg)
                #print("bad prefix: ", self.CMD_PREFIX)
                return
            # end if
