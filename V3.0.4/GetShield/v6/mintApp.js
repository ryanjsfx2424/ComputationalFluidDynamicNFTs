...
function App() {
  ...
  const [feedback, setFeedback] = useState(`Claim up to 7 MetaGems Land per Tx`);
                    ...
                    {blockchain.account === "" ||
                      ...
                      <>
                        ...
                        <s.FlexContainer ai={"center"} jc={"center"} fd={"column"}>
                          <div>
                            <label>Token IDs to claim:</label>
                            <input className="inputBox" type= 'text' placeholder="Multiple Tokens: 1,4,8" onChange={(e) => setInputTokenList(e)} />
                            <br></br>
                          </div>
