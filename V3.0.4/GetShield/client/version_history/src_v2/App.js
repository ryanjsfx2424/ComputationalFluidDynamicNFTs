      ...
      >
        <s.Con
          ...
          <s.smallCon
            className="mainBox">
            <s.logoCon>
              <StyledLogo alt={"logo"} src={"/config/images/shieldLogoWhite.png"} />
              <form>
                <input className="inputBox" type= 'text' placeholder="Search Contracts / Addresses" onChange={(e) => setContractAddress(e)} />
              </form>
