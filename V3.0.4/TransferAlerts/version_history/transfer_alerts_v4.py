            ...
            for jj in range(len(self.settings["collections"])):
                ...
                for ii in range(10):
                  try:
                    ...
                    await self.channel_log.send("489 warning! couldn't driver.get for os_url: " + os_url)
                    print("487 err: ", err)
                    print("488 err: ", err.args[:])
                    print("489 ii: ", ii)
                    await aysncio.sleep(self.QS)
                  # end try/except
                # end for ii
                if flag:
                  ...
                  try:
                    ...
                    msg = "501 OS collection not found for contract: " + contract
                    print(msg)
                    await self.channel_log.send(msg)
                    #print("err 405: ", err)
