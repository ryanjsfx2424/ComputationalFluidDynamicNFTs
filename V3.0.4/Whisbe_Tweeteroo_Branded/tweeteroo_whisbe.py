...
class Tweeteroo2(object):
    ...
    def init_stream_data(self):
        ...
        if not self.DEV_MODE:
            os.system("nohup python3 -u stream_whisbe.py > logfile_stream.txt 2>&1 &")
        # end if not
    ...
    def init_data(self):
        ...
        if not self.DEV_MODE:
            os.system("nohup python3 -u engagement_whisbe.py likes > logfile_likes.txt 2>&1 &")
            os.system("nohup python3 -u engagement_whisbe.py retweets > logfile_retweets.txt 2>&1 &")
            os.system("nohup python3 -u engagement_whisbe.py quotes > logfile_quotes.txt 2>&1 &")
