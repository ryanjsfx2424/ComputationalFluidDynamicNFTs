...
#    # end for images
  ...
  def discord_bot(self):
    ...
    async def on_ready():
      ...
      await channel_usa.send("test")
      print(dir(channel_usa))
      threads = channel_usa.threads
      print("threads 346: ", threads)
      threads2 = channel_usa.threads()
      print("threads2 348: ", threads2)
      sys.exit()
      for cname in list(self.CIDS_USA.keys()):
        channel = client.get_channel(self.CIDS_USA[cname])
