...
class ScrapeTweets(object):
  ...
  def discord_bot(self):
    ...
    client = commands.Bot(command_prefix = ["rtt","!rtt"], help_command=None)
    ...
    @client.command(aliases=["help","hlp"])
    async def halp(ctx): # ctx == context
    ...
    async def on_message(message):
      ...
      if msg.startswith("rtt") or msg.startswith("!rtt"):
        msg = msg.replace("@","")

        if msg.startswith("!rttstats") or msg.startswith("!rtt stats") or \
